<h3 style=" text-align: center;">Anda Login Sebagai User</h3><hr>
...
<table width="100%">
	...
	?>
		<tr>
			...
			<td style=" text-align: center;"> <?php if($row->jumlah_stok>0){ echo 'Tersedia';} else {echo 'Habis';}; ?>
...
<?php
	...
	if($id>1) : echo "<li><a href='?p=data_produk_kasir&q={$cari}&page=".($id-1)."' class='button'>Sebelumnya</a></li>"; endif;
	if($id!=$total) : echo "<li><a href='?p=data_produk_kasir&q={$cari}&page=".($id+1)."' class='button'>Berikutnya</a></li>"; endif;
	for($i=1;$i<=$total;$i++) :
		if($i==$id) : 
				echo "<li><a class='active' href='#'>".$i."</a></li>"; 
		else :
				echo "<li><a href='?p=laman_utama_kasir&q={$cari}&page=".$i."'>".$i."</a></li>"; 
		endif;
	endfor;
	?>
</ul>
