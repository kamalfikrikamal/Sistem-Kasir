...
<table width="100%">
	...
	?>
		<tr>
			...
			<td> 
			<a href="?p=edit_produk&id=<?php echo $row->id_produk; ?>" class="text-blue">Edit Produk</a> | <a href="#" onclick="delete_barang('<?php echo $row->id_produk; ?>');" class="text-red">Hapus</a></td>
		</tr>
	<?php endwhile; ?>
	</tbody>
</table>
